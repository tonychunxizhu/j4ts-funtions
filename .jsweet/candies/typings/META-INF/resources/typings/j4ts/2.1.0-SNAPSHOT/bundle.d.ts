...
declare namespace java.io {
    ...
    class IOUtils {
         ...
         *
         * @param {byte[]} buffer Array of bytes to be checked.
...
declare namespace java.lang.reflect {
    class Array {
        constructor();
        static newInstance(componentType: any, length: number): any;
    }
}
declare namespace java.lang.reflect {
    /**
...
declare namespace java.text {
    class Normalizer {
        static normalize(src: any, form: Normalizer.Form): string;
    }
...
declare namespace java.util {
    ...
    interface Iterator<E> {
        hasNext(): boolean;
        next(): E;
        forEachRemaining(consumer: (p1: any) => void): any;
        remove(): any;
    }
}
declare namespace java.util {
...
declare namespace java.util {
    ...
    class Locale {
        ...
        static FRANCE_$LI$(): Locale;
        static UK: Locale;
        static UK_$LI$(): Locale;
...
declare namespace java.util {
    ...
    interface Map<K, V> {
        ...
        replaceAll(__function: (p1: any, p2: any) => any): any;
    }
    namespace Map {
        /**
...
declare namespace javaemul.internal {
    ...
    namespace EmulatedCharset {
        ...
        class UtfCharset extends javaemul.internal.EmulatedCharset {
             ...
             *
             * @param {byte[]} bytes byte array to store character in
...
declare namespace java.security {
    ...
    namespace MessageDigest {
        class Md5Digest extends java.security.MessageDigest {
             ...
             *
             * @param {byte[]} in A byte[].
             * @param {int[]} out An int[].
             * @private
             */
...
declare namespace java.util {
    ...
    class ArrayDeque<E> extends java.util.AbstractCollection<E> implements java.util.Deque<E>, java.lang.Cloneable {
        ...
        clear(): void;
        clone(): any;
        contains$java_lang_Object(o: any): boolean;
        /**
         *
         * @return {*}
         */
         ...
         * @private
         */
        removeAtIndex(i: number): number;
        shiftLeftAtIndex(i: number): void;
        shiftRightAtIndex(i: number): void;
    }
...
declare namespace javaemul.internal {
    ...
    class StringHelper {
        ...
        static join(delimiter: any, ...elements: any[]): string;
        constructor();
    }
}
...
declare namespace java.util.stream {
    class Collectors {
        ...
        static CH_ID: java.util.Set<java.util.stream.Collector.Characteristics>;
        static CH_ID_$LI$(): java.util.Set<java.util.stream.Collector.Characteristics>;
        static CH_NOID: java.util.Set<java.util.stream.Collector.Characteristics>;
        static CH_NOID_$LI$(): java.util.Set<java.util.stream.Collector.Characteristics>;
    ...
    namespace Collectors {
        class CollectorImpl<T, A, R> implements java.util.stream.Collector<T, A, R> {
            ...
            __characteristics: java.util.Set<Collector.Characteristics>;
            __finisher: (p1: A) => R;
            constructor(supplier?: any, accumulator?: any, combiner?: any, finisher?: any, characteristics?: any);
            static castingIdentity<I, R>(): (p1: I) => R;
            /**
             *
             * @return {*}
             */
...
declare namespace javaemul.internal {
    ...
    class InternalPreconditions {
         ...
         * @param {java.lang.Object[]} errorMessageArgs
         */
